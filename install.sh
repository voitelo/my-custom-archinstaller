...
ROOT_PART=$(lsblk -dpno NAME | fzf --prompt="Root partition: ")
echo "Select boot (EFI) partition:"
BOOT_PART=$(lsblk -dpno NAME | fzf --prompt="Boot partition: ")
...
pacstrap -K /mnt base linux-zen linux-firmware sudo nano micro networkmanager grub efibootmgr kitty fastfetch
